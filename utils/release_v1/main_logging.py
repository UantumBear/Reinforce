...
#         raise RuntimeError("Google API Key가 설정되지 않았습니다.")
# elif Settings.USE_AZURE:
#     if not Settings.AZURE_OPENAI_API_KEY or not Settings.AZURE_OPENAI_ENDPOINT:
#         raise RuntimeError("Azure API Key/Endpoint가 설정되지 않았습니다.")
...
#     print("Setting:", "Azure OpenAI" if Settings.USE_AZURE else "Google Gemini (Free)")
#     print("=" * 60)
#     print(f"[DEBUG] USE_AZURE environment variable: {os.getenv('USE_AZURE')}")
#     print(f"[DEBUG] USE_AZURE parsed value: {Settings.USE_AZURE}")
