...
# @내역 :
# - 1차 강화학습 기말 과제 프로젝트용으로 썼던 main_logging.py 파일은 release v1 버전에 구현되어 있으며,
# - 현재 이 파일은 미사용.
# """
# import time
...
# from utils.datasets.rag_cot_en_ko import RagCotEnKoDataset # RAG-COT-En_KO 데이터셋
...
#         Settings.setup()
#         self.use_azure = Settings.USE_AZURE # LLM 모델, 임베딩 모델에서 azure 를 사용할 지 여부 (... 과제 제출용으로 사용하지 않음.)
...
#         self.dataset = RagCotEnKoDataset(split="train", max_samples=1000) # RAG-COT-En_KO 데이터셋 로드 (영어 컨텍스트, 한국어 질문/답변)
