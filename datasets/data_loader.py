...
# 이 파일(data_loader.py)의 부모(datasets)의 부모(ProjectRoot)
...
def load_dataset(file_path=None, sample_size=None):
    ...
    if file_path is None:
        # 기본적으로 읽어올 파일 경로 설정
        file_path = BASE_DIR / "datasets/original/didi0di/klue-mrc-ko-rag-cot/search_result_3.csv"
