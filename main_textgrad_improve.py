...
# TEXTGRAD
import textgrad as tg # 순서 1. 여기서는 몽키패치 전의 tg 가 import 된다. 
from utils.environment.experiment import TextGradExperiment # 순서 2. 여기서도 몽키패치 전이다. (이 instance 가 생성된 이후에 몽키패치가 tg에 몽키패치가 적용된다. )
...
def main():
    ...
    EXPERIMENT_INS = TextGradExperiment(mode='improve')  # 실험 모드 선택 (baseline/improve)
